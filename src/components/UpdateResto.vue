...
export default{
    ...
    methods:{
        async updateResto(){
            ...
            let result = await axios.put("http://localhost:3000/restourants/"+this.$route.params.id, {
    ...
    async mounted() {
        ...
        let result= await axios.get("http://localhost:3000/restourants/"+this.$route.params.id)
